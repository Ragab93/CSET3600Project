    ...
    public class PeopleContext :DbContext
    {
       ...
       // public DbSet<Switch> switchs { get; set; }
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server=tcp:vnet2.database.windows.net,1433;Initial Catalog=VNET2-sql;Persist Security Info=False;User ID=webappuser;Password=Mmd44035;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;Persist Security Info=True; ");
        }
